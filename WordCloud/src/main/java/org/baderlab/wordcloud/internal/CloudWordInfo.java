...
public class CloudWordInfo implements Comparable<CloudWordInfo>
{
	 ...
	 */
	public JLabel createCloudLabel(final CyApplicationManager applicationManager, final SemanticSummaryManager cloudManager, final SemanticSummaryPluginAction pluginAction)
	{
	...
	{
		String[] splitString = {word, Integer.toString(fontSize), Integer.toString(cluster), Integer.toString(wordNum)};
		return splitString;
	}
